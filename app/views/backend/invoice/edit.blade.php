...
<div class="panel-body">
    <div class="row">
        {{ Form::model($entry, ['method' => 'PATCH','route'=>['admin.invoices.update', $entry->id], 'files' => 'true']) }}
        {{ Form::hidden('id', $entry->id, array('id' => 'id')) }}

        @if($entry->from_order == '1')
        @foreach($imported as $singleimport)
        ...
        <div class="col-md-9">
                ...
                <div class="form-group">  
                    ...
                    {{ Form::text('invoice_number', isset($entry->invoice_number) ? $entry->invoice_number : null, ['class' => 'form-control']) }}
                ...
                <div class="col-md-2">
                    ...
                    {{ Form::select('invoice_type', array('R' => 'R', 'R1' => 'R1', 'R2' => 'R2', 'bez_oznake' => 'bez oznake', 'avansni' => 'Avansni'),  isset($entry->invoice_type) ? $entry->invoice_type : null, array('class'=>'form-control')) }}
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                  <div class="form-group imported-items">  
                                        {{ Form::label('productname', 'Proizvod:') }}
                                        {{ Form::label('productname', $singleimport['importedOrders'][0]->name, ['class' => 'imported-items']) }}
                                        </div>
                                </div>
                                <div class="col-md-4">
                                 <div class="form-group">  
...
<div class="form-group">  
               ...
               <div class="form-group">  
                ...
                <div class="form-group">  
                    ...
                    {{ Form::textarea('invoice_note', isset($entry->invoice_note) ? $entry->invoice_note : null, ['class' => 'form-control', 'id' => 'invoice_note']) }}
                  ...
                  <a href="#options" class="btn btn-info margin-bottom30" style="margin-left:15px;" data-toggle="collapse">Dodatne opcije</a>
                   ...
                   <div class="form-group">  
                    ...
                    {{ Form::select('repeat_invoice', array('0' => 'Ne', '1' => 'Da'), isset($entry->repeat_invoice) ? $entry->repeat_invoice : null, array('class'=>'form-control' )) }}
                ...
                <div class="col-md-2">
                    ...
                    {{ Form::select('invoice_language', array('croatian' => 'Hrvatski', 'english' => 'Engleski', 'german' => 'Njemački', 'french' => 'Francuski', 'italian' => 'Talijanski'), isset($entry->invoice_language) ? $entry->invoice_language : null, array('class'=>'form-control' )) }}
