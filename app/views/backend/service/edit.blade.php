...
<ul class="breadcrumb">
    ...
    <li><a href="{{ URL::route('ServiceIndex') }}">Pregled svih oznaka</a></li>
    <li class="active">Uredi oznaku</li>
</ul>
	...
	<div class="row">
	    ...
	    <div class="col-md-6">
	            <div class="form-group">  
					...
					{{ Form::text('intro', isset($entry->intro) ? $entry->intro : null, ['class' => 'form-control', 'id' => 'intro', 'placeholder' => 'Opis oznake']) }}
					<small class="text-danger">{{ $errors->first('intro') }}</small>
	            </div>    
                                <div class="col-md-2">
                        <div class="form-group">  
                    <label for="measurement">Jedinična mjera:</label>
                    {{ Form::select('measurement', array('piece' => 'kom', 'hour' => 'sat', 'year' => 'god', 'km' => 'km', 'lit' => 'lit', 'kg' => 'kg', 'kWh' => 'kWh', 'm³' => 'm³', 't' => 't', 'm²' => 'm²', 'm' => 'm', 'day' => 'dan', 'night' => 'noć', 'kart' => 'kart', 'rč' => 'rč', 'par' => 'par', 'ml' => 'ml', 'pax' => 'pax', 'room' => 'soba', 'apt' => 'apt', 'term' => 'term', 'set' => 'set', 'pak' => 'pak', 'bod' => 'bod', 'usi' => 'usi'),  isset($entry->measurement) ? $entry->measurement : null, array('class'=>'form-control','style'=>'' )) }}
