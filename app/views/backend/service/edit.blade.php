...
<ul class="breadcrumb">
    ...
    <li class="active">Uredi uslugu</li>
</ul>
...
<div class="panel-body">
	<div class="row">
		{{ Form::model($service, ['method' => 'PATCH','route'=>['admin.services.update', $service->id], 'files' => 'true']) }}
		{{ Form::hidden('id', $service->id, array('id' => 'id')) }}
	    <div class="col-md-6">
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::select('measurement', array('piece' => 'kom', 'hour' => 'sat', 'year' => 'god', 'km' => 'km', 'lit' => 'lit', 'kg' => 'kg', 'kWh' => 'kWh', 'm³' => 'm³', 't' => 't', 'm²' => 'm²', 'm' => 'm', 'day' => 'dan', 'night' => 'noć', 'kart' => 'kart', 'rč' => 'rč', 'par' => 'par', 'ml' => 'ml', 'pax' => 'pax', 'room' => 'soba', 'apt' => 'apt', 'term' => 'term', 'set' => 'set', 'pak' => 'pak', 'bod' => 'bod', 'usi' => 'usi'), $service->measurement,  ['class'=>'form-control']) }}
