	...
	<div class="row">
        ...
        <div class="col-md-7">
                ...
                <div class="form-group">  
                    ...
                    {{ Form::text('offer_number', isset($newoffernumber) ? $newoffernumber : null, ['class' => 'form-control', 'id' => 'offer_number', 'placeholder' => 'Broj ponude']) }}
...
<div class="form-group">  
                ...
                <div class="col-md-2">
                <div class="form-group">  
                    <label for="offer_start">Početak isporuke:</label>
                ...
                <div class="col-md-2">
                <div class="form-group">  
                    <label for="offer_end">Kraj isporuke:</label>
                ...
                <div class="col-md-12">
                <div class="form-group">  
                    <label for="offer_note">Napomene:</label>
                    {{ Form::textarea('offer_note', isset($entry->offer_note) ? $entry->offer_note : null, ['class' => 'form-control', 'id' => 'offer_note', 'placeholder' => 'Napomene na računu']) }}
                ...
                <div class="col-md-2">
                    ...
                    {{ Form::select('offer_language', array('croatian' => 'Hrvatski', 'english' => 'Engleski', 'german' => 'Njemački', 'french' => 'Francuski', 'italian' => 'Talijanski'), 'croatian', array('class'=>'form-control','style'=>'' )) }}
