...
<div class="panel-body">
    <div class="row">
        {{ Form::model($entry, ['method' => 'PATCH','route'=>['admin.offers.update', $entry->id], 'files' => 'true']) }}
        {{ Form::hidden('id', $entry->id, array('id' => 'id')) }}
        <div class="col-md-7">
                <div class="col-md-3">
                <div class="form-group">  
                    {{ Form::label('offer_number', 'Broj ponude:') }}  
                    {{ Form::text('offer_number', isset($entry->offer_number) ? $entry->offer_number : null, ['class' => 'form-control']) }}
                ...
                <div class="col-md-2">
                   <div class="form-group">  
                    ...
                    {{ Form::select('tax', array('0' => 'Ne', '1' => 'Da'), isset($entry->tax) ? $entry->tax : null, array('class'=>'form-control')) }}
                   ...
                   <div class="form-group">  
                    ...
                    {{ Form::select('hide_amount', array('0' => 'Ne', '1' => 'Da'), isset($entry->hide_amount) ? $entry->hide_amount : null, array('class'=>'form-control')) }}
                ...
                <div class="form-group">  
                    ...
                    {{ Form::select('client_id', $clientlist, isset($entry->client_id) ? $entry->client_id : null, array('class' => 'form-control', 'style' => 'width:100%')) }}
                ...
                <div class="form-group">  
                    ...
                    {{ Form::text('client_address', isset($entry->client_address) ? $entry->client_address : null, ['class' => 'form-control']) }}
                ...
                <div class="form-group">  
                    ...
                    {{ Form::text('client_oib', isset($entry->client_oib) ? $entry->client_oib : null, ['class' => 'form-control']) }}
                ...
                <div class="form-group">  
                    ...
                    {{ Form::select('product[]', $productlist, isset($singleoffer->product_id) ? $singleoffer->product_id : null, array('class' => 'form-control multiselect', 'style' => 'width:100%')) }}
                ...
                <div class="col-md-2">
                   <div class="form-group">  
                    ...
                    {{ Form::text('amount[]', isset($singleoffer->amount) ? $singleoffer->amount : null, ['class' => 'form-control']) }}
                ...
                <div class="col-md-2">
                   <div class="form-group">  
                    ...
                    {{ Form::text('price[]', isset($singleoffer->price) ? $singleoffer->price : null, ['class' => 'form-control']) }}
                   ...
                   <div class="form-group">  
                    ...
                    {{ Form::text('discount[]', isset($singleoffer->discount) ? $singleoffer->discount : null, ['class' => 'form-control', 'placeholder' => '%']) }}
                ...
                <div class="col-md-1"></div>
                   ...
                   <div class="form-group">  
                    ...
                    {{ Form::text('taxpercent[]', isset($singleoffer->taxpercent) ? $singleoffer->taxpercent : null, ['class' => 'form-control', 'placeholder' => '%']) }}
...
<div class="form-group">  
                    {{ Form::label('product', 'Proizvod:') }}   
                    {{ Form::select('product[]', $productlist, isset($entry->product) ? $entry->product : null, array('class' => 'form-control multiselect', 'style' => 'width:100%')) }}
                    <small class="text-danger">{{ $errors->first('product') }}</small>
                        </div>
                        </div>
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                   <div class="form-group">  
                    {{ Form::label('amount', 'Količina:') }} 
                    {{ Form::text('amount[]', isset($entry->amount) ? $entry->amount : null, ['class' => 'form-control']) }}
                    <small class="text-danger">{{ $errors->first('amount') }}</small>
                </div>    
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-2">
                   <div class="form-group">  
                    {{ Form::label('price', 'Cijena:') }} 
                    {{ Form::text('price[]', isset($entry->price) ? $entry->price : null, ['class' => 'form-control']) }}
                    <small class="text-danger">{{ $errors->first('price') }}</small>
                </div>    
                </div>
                    <div class="col-md-1"></div>
                   ...
                   <div class="form-group">  
                    {{ Form::label('discount', 'Popust:') }} 
                    {{ Form::text('discount[]', isset($entry->discount) ? $entry->discount : null, ['class' => 'form-control','placeholder' => '%']) }}
                    <small class="text-danger">{{ $errors->first('discount') }}</small>
                </div>    
                </div>
                <div class="col-md-1"></div>
                   ...
                   <div class="form-group">  
                    {{ Form::label('taxpercent', 'Stopa:') }} 
                    {{ Form::text('taxpercent[]', isset($entry->taxpercent) ? $entry->taxpercent : null, ['class' => 'form-control', 'placeholder' => '%']) }}
                    <small class="text-danger">{{ $errors->first('taxpercent') }}</small>
                </div>    
                </div>
                                      </div>
                ...
                <div class="form-group">  
                    ...
                    {{ Form::text('offer_start', isset($entry->offer_start) ? $entry->offer_start : null, ['class' => 'form-control datepicker']) }}
                ...
                <div class="form-group">  
                    ...
                    {{ Form::text('offer_end', isset($entry->offer_end) ? $entry->offer_end : null, ['class' => 'form-control datepicker']) }}
                ...
                <div class="form-group">  
                    ...
                    {{ Form::textarea('invoice_note', isset($entry->offer_note) ? $entry->offer_note : null, ['class' => 'form-control']) }}
                ...
                <div class="col-md-2">
                    ...
                    {{ Form::select('offer_language', array('croatian' => 'Hrvatski', 'english' => 'Engleski', 'german' => 'Njemački', 'french' => 'Francuski', 'italian' => 'Talijanski'), isset($entry->offer_language) ? $entry->offer_language : null, array('class'=>'form-control' )) }}
                ...
                <div class="col-md-1"></div>
                   ...
                   <div class="form-group">  
                    ...
                    {{ Form::text('valute', isset($entry->valute) ? $entry->valute : null, ['class' => 'form-control', 'placeholder' => '%']) }}
