...
<ul class="breadcrumb">
    ...
    <li class="active">Uredi tvrtku</li>
</ul>
...
<div class="panel-body">
    ...
    <div class="row"> 
        ...
        {{ Form::model($company, ['method' => 'PATCH','route'=>['admin.company.update', $company->id], 'files' => 'true']) }}

        <div class="col-md-4">  
            @if ($company->image != null || $company->image != '') 
            <div class="form-group">
                <h5> {{ Form::label('image', 'Logotip:') }}</h5> 
                {{ HTML::image(URL::to('/') . '/uploads/backend/company/' . $company->image, $company->title) }} 
            </div> 
            @endif
        
            <div class="form-group"> 
                {{ Form::label('image', 'Promjeni logotip:') }}
