...
<ul class="breadcrumb">
    ...
    <li><a href="{{ URL::route('NarudzbeniceIndex') }}">Pregled svih naružbenica</a></li>
...
<div class="form-group">  
                ...
                <div class="col-md-2">
                <div class="form-group">  
                    <label for="narudzbenica_start">Početni datum:</label>
                ...
                <div class="col-md-2">
                <div class="form-group">  
                    <label for="narudzbenica_end">Završetak:</label>
                ...
                <div class="col-md-12">
                <div class="form-group">  
                    <label for="narudzbenica_note">Napomene:</label>
                ...
                <div class="col-md-2">
                        <div class="form-group">  
                    <label for="narudzbenica_language">Jezik otpremnice:</label>  
